# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 00:48:31 2019
...
def again1():
    word_user1 = input('''Do you want to Search again? Please type Y for YES or N for NO. --''')

    # Accept 'y' or 'Y' by adding str.upper()
    if word_user1.upper() == 'Y':
        #Input from user
        user_input = input("Enter a word: ")
        output1 = retrive_definition(user_input)
